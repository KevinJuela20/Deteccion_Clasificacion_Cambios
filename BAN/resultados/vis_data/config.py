...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=40, save_best='mIoU', type='CheckpointHook'),
...
launcher = 'none'
load_from = 'checkpoint/iter_40000.pth'
log_level = 'INFO'
...
train_cfg = dict(max_iters=400, type='IterBasedTrainLoop', val_interval=40)
